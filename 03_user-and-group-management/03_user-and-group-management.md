...
## 💡 What will you learn?
useradd, usermod, groups, sudoers
...
## 📈 Diagram (ASCII)
```
[ 03_user-and-group-management concept diagram ]
```
...
## 📝 Exercise
```bash
# Example exercise for 03_user-and-group-management
