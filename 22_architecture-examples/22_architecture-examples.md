...
## 💡 What will you learn?
2‑tier VPC, public/private subnet diagrams, RDS links
...
## 📈 Diagram (ASCII)
```
[ 22_architecture-examples concept diagram ]
```
...
## 📝 Exercise
```bash
# Example exercise for 22_architecture-examples
